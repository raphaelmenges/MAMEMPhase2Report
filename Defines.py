...
User = collections.namedtuple('User', 'nickname date')
user_filter = [
		User('sheba1', 	datetime.datetime(2018, 3, 1,  10, 1,  0)),
		User('sheba2', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba3', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba4', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba5', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba6', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba7', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba8', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba9', 	datetime.datetime(2018, 3, 1,  0,  1,  0)),
		User('sheba10', 	datetime.datetime(2018, 3, 1,  0,  1   0)),
